...
//
// Antes esto no existía y había cuatro sitios llamando a
// `Geolocator.requestPermission()` por su cuenta; el peor, el home, lo lanzaba
// desde `initState`: el diálogo saltaba al entrar a la pantalla, sin que nadie
// hubiera pedido nada y sin una palabra de contexto.
//
...
// `lib/` para comprobarlo. El resto del código pregunta con [concedido], que
// nunca abre un diálogo.

abstract final class Ubicacion {
  /// ¿Tenemos permiso YA? Nunca pregunta ni abre nada.
  ///
  /// Para los sitios que solo quieren aprovechar el GPS si está disponible —el
  /// mapa del home al abrirse, el mandado que si no ancla la búsqueda en el
  /// centro— y que no deben interrumpir a nadie.
          ...
          child: Column(
            ...
            children: [
              ...
              const _Punto(
                ...
                texto: 'Recogemos tu ubicación precisa mientras usas la app.',
              ),
              const _Punto(
                icono: Icons.route_rounded,
                texto: 'Sirve para fijar tu punto de recogida, mostrarte los '
                    'conductores que tienes cerca y calcular el precio del '
                    'trayecto.',
              ),
              const _Punto(
                icono: Icons.people_alt_rounded,
                texto: 'Se envía a los servidores de ZIPA. Durante un servicio, '
                    'el conductor asignado ve tu punto de recogida y tu destino.',
              ),
              const _Punto(
                icono: Icons.timer_off_rounded,
                texto: 'Nunca se recoge con la app cerrada, y deja de recogerse '
                    'en cuanto sales.',
              ),
