...
//
// El barrido es de `lib/` entera: aquí solo había un sitio
// (`LocationService.requestPermissions`) y está migrado, así que cualquier
// reaparición es deuda nueva.
//
// En esta app el dato es más sensible que en la del pasajero: es rastreo
// continuo mientras se está en línea, incluso con la pantalla apagada.
