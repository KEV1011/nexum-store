...
///
/// Se renueva solo poco antes de vencer, para que un turno largo no vea el mapa
/// caer a OpenStreetMap a mitad de camino.
    ...
    if (ticket == null || ticket.isEmpty) {
      return _oscurecer(
        TileLayer(
          ...
          userAgentPackageName: 'com.zipa.conductor',
        ),
      );
    }
