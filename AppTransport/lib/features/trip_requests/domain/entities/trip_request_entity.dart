...
class TripRequestEntity {
  ...
  /// Detalle de la entrega, presente solo cuando la solicitud corresponde
  /// al modo Pedido (domicilio) o Paquete (envío).
  ...
  /// Indica si esta solicitud es una entrega (pedido o paquete).
